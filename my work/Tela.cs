class Tela
{
    ...
    public void montarTelaGeral()
    {
        ...
        this.centralizar(1,0,79,"Filipe's Biblioteca");
    }
    ...
    public void montarMoldura(int ci, int li, int cf, int lf)
    {
        ...
        // "arruma" os cantos
        Console.SetCursorPosition(ci, li); Console.Write(" 0 ");
        Console.SetCursorPosition(ci, lf); Console.Write(" 0 ");
        Console.SetCursorPosition(cf, li); Console.Write(" 0 ");
        Console.SetCursorPosition(cf, lf); Console.Write(" 0 ");
    }
    ...
    public void montarLinhaHor(int lin, int ci, int cf)
    {
        ...
        Console.SetCursorPosition(ci,lin); Console.Write(" 0 ");
        Console.SetCursorPosition(cf,lin); Console.Write(" 0 ");
    }
